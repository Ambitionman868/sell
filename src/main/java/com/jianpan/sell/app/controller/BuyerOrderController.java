...
import com.jianpan.sell.app.converter.OrderForm2OrderDTOConverter;
...
import com.jianpan.sell.app.service.BuyerService;
...
public class BuyerOrderController {
    ...
    public ResultVO<List<OrderDTO>> list(@RequestParam("openid") String openid,
        ...
        Page<OrderDTO> pageDTO = orderService.findList(pageRequest);
        return ResultVOUtil.success(pageDTO.getContent());
    ...
    public ResultVO cancel(@RequestParam("openid") String openid,
                           @RequestParam("orderId") String orderId) {
        // todo buyerService.cancelOrder(openid, orderId);
